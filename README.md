...
## Estatísticas:  
- Porcentagem de contas com probabilidade acima de **75%** de serem bots: **26.5465129295869%**  
  - Obs: essa porcentagem foi feita com base em uma população de **44665** contas ( a mesma usada no gráfico )  
- Porcentagem de contas sem timeline: **35.4544427852581%**  
- Porcentagem de contas removidas: **0.451744864539283%**  
- Porcentagem de contas reportadas por nós: **1.46942565659861%**  
- Porcentagem de contas reportadas por nós *e* removidas: **0%**  
  - Obs: essas porcentagens foram feitas com base na população total verificada: **79691** contas ( Botometer não consegue estudar contas sem timeline )  
