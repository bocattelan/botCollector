...
## Estatísticas:  
Porcentagem de contas com probabilidade acima de **75%** de serem bots: **25.0249603570799%**  
Obs: essa porcentagem foi feita com base em uma população de **17027** ( a mesma usada no gráfico )  
Porcentagem de contas sem timeline: **35.4366789993551%**  
Obs: essa porcentagem foi feita com base na população total verificada: **29461** ( Botometer não consegue estudar contas sem timeline )  
# English  
## botCollector  
